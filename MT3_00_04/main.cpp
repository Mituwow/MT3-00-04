...
Matrix4x4 MakeRotateXMatrix4x4(float radian) {
	Matrix4x4 result;
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
...
Matrix4x4 MakeRotateYMatrix4x4(float radian) {
	Matrix4x4 result;
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
...
Matrix4x4 MakeRotateZMatrix4x4(float radian) {
	Matrix4x4 result;
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 rotateXMatrix = MakeRotateXMatrix4x4(rotate.x);
	Matrix4x4 rotateYMatrix = MakeRotateYMatrix4x4(rotate.y);
	Matrix4x4 rotateZMatrix = MakeRotateZMatrix4x4(rotate.z);
